...
import com.jhash.oimadmin.ui.oim.eventHandlers.EventHandlerUI;
...
public class PluginPackagePanel extends AbstractUIComponent<JPanel, PluginPackagePanel> {
    ...
    public void setupDisplayComponent() {
        ...
        eventHandlerCodeJar = getConfiguration().getWorkArea() + File.separator + Config.VAL_WORK_AREA_TMP + File.separator
        ...
        selectJar = new JFileChooser(getConfiguration().getWorkArea() + File.separator + Config.VAL_WORK_AREA_TMP);
        ...
        eventHandlerPluginZip = getConfiguration().getWorkArea() + File.separator + Config.VAL_WORK_AREA_TMP + File.separator
